  ...
  <div class="w-100">
    <div class="d-flex pt-1 pb-4">
      <div class="w-100 text-center">
        <h2>Build a world-class fleet safety program</h2>
      </div>
    </div>
    ...
    <div class="d-flex justify-center">
      <div class="lg-container w-100 z-10">
        <div class="pt-0 pb-4 px-4">
          <div class="video">
            <video playsinline="" autoplay="autoplay" muted="muted" preload="auto" loop="loop" class="w-100">
              <source src="//videos.ctfassets.net/bx9krvy0u3sx/gFr2ZvCIENOBM0MEgnpsq/1e579b0e37a7a8834997b2afdba0dbf3/VP1_video_v2.2.mp4">
              <track kind="captions">
            </video>
          </div>
        </div>
    ...
    <div id="hdvideo" class="text-center pb-5">
      <div class="row">
